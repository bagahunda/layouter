...
export default class Particles {
  ...
  init(src) {
    console.log("particels -> init");

    const loader = new THREE.TextureLoader();

    loader.load("sample-03.png", texture => {
  ...
  addListeners() {
    ...
    console.log(
      "​Particles -> addListeners -> this.handlerInteractiveMove",
      this.handlerInteractiveMove
    );

    console.log("​Particles -> addListeners -> this.webgl", this.webgl);
